...
?>
<nav class="navbar navbar-fixed-top <?php echo trim(implode(' ', $navbar_classes)) ?>" role="navigation">
  ...
  <div class="container">
    ...
    <div class="navbar-header">
      ...
      <?php
        ...
        tpl_link(
            wl(),
            '<img src="'.$logo.'" alt="'.$title.'" class="pull-left logo'.(($tagline) ? ' dw-logo-tagline' : '').'" id="dw__logo" '.$logo_size.' /> <span id="dw__title" '.($tagline ? 'style="margin-top:-5px"': '').'>'. $title . $tagline .'</span>',
